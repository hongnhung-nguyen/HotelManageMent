...
/
--5
CREATE TABLE A_CTLUHANH(
    MACONGTY        VARCHAR2(10),
    TENCONGTY       NVARCHAR2(100),
    CONSTRAINT PK_DVLUHANH PRIMARY KEY (MACONGTY)
);
/
--6
...
--16
/
CREATE TABLE A_TOUR_KHACHHANG(
    MAKH        VARCHAR2(10),
    MATOUR      VARCHAR2(10),
    THOIGIAN    DATE,
    SOLUONG     NUMBER(3,0),
    DICHUYEN    VARCHAR2(100),
    YEUCAU      VARCHAR2(100),
    CONSTRAINT PK_TOUR_KH PRIMARY KEY(MAKH, MATOUR)
);